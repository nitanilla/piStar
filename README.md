# piStar - An Online Tool for Awareness Goal Modeling
 ...
 This is an open-source goal modelling tool. Its key distinguishing characteristics are:
  ...
  - supports the [iStar 1.0 standard](http://www-di.inf.puc-rio.br/~julio/tese-herbet.pdf#page=63) 
  - supports Awareness Goal Modeling, using the [Souza, 14] approach in his [PhD Thesis](http://www-di.inf.puc-rio.br/~julio/tese-herbet.pdf#page=83) 
