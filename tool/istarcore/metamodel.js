...
istar.setupMetamodel = function (metamodel) {
    ...
    joint.dia.Cell.prototype.isKindOfInnerElement = function () {
        return this.isGoal() || this.isQuality() || this.isTask() || this.isResource() || this.isGoalAwareness() || this.isQualityAwareness() || this.isTaskAwareness() || this.isResourceAwareness();
    };
